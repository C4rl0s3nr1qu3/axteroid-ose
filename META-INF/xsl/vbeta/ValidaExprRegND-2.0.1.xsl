...
<xsl:stylesheet  version="2.0" 
	...
	<xsl:template match="/*">
		...
		<xsl:variable name="porcentajeIGVVigenteLinea" select="max(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[cac:TaxScheme/cbc:ID[text() = '1000' or text() = '9996']]/cbc:Percent)"/>
		...
		<xsl:variable name="codigoTipoNotaDebito" select="cac:DiscrepancyResponse/cbc:ResponseCode"/>
		<!-- 8. Tipo de moneda -->
		...
		<xsl:variable name="sumValorVentaItem1000Linea" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='1000']/cbc:LineExtensionAmount)"/>	
		<xsl:variable name="sumValorVentaItem1016Linea" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='1016']/cbc:LineExtensionAmount)"/>	
		<xsl:variable name="sumValorVentaItem9995Linea" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='9995']/cbc:LineExtensionAmount)"/>	
		<xsl:variable name="sumValorVentaItem9996Linea" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='9996']/cbc:LineExtensionAmount)"/>	
		<xsl:variable name="sumValorVentaItem9997Linea" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='9997']/cbc:LineExtensionAmount)"/>	
		<xsl:variable name="sumValorVentaItem9998Linea" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='9998']/cbc:LineExtensionAmount)"/>	

		<!-- 33. Código de precio -->
		<xsl:variable name="countCodigoPrecio01Global" select="count(cac:DebitNoteLine/cac:PricingReference/cac:AlternativeConditionPrice/cbc:PriceTypeCode[text()='01'])"/>
		<xsl:variable name="countCodigoPrecio02Global" select="count(cac:DebitNoteLine/cac:PricingReference/cac:AlternativeConditionPrice/cbc:PriceTypeCode[text()='02'])"/>				
		...
		<!-- 34. Monto base -->
		<xsl:variable name="sumMontoBaseGlobal" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount)"/>		
		<!-- 34. Monto base por Código de tributo por línea-->
		<xsl:variable name="sumMontoBase1000Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1000']/cbc:TaxableAmount)"/>		
		<xsl:variable name="sumMontoBase1016Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1016']/cbc:TaxableAmount)"/>
		<xsl:variable name="sumMontoBase2000Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='2000']/cbc:TaxableAmount)"/>
		<xsl:variable name="sumMontoBase9995Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9995']/cbc:TaxableAmount)"/>
		<xsl:variable name="sumMontoBase9996Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9996']/cbc:TaxableAmount)"/>
		<xsl:variable name="sumMontoBase9997Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9997']/cbc:TaxableAmount)"/>
		<xsl:variable name="sumMontoBase9998Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9998']/cbc:TaxableAmount)"/>
		<xsl:variable name="sumMontoBase9999Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9999']/cbc:TaxableAmount)"/>

		<xsl:variable name="sumMontoBase2000_9996Linea">	
			<xsl:choose>
				<xsl:when test="($sumMontoBase2000Linea &gt; 0)">					
					<xsl:for-each select="cac:DebitNoteLine/cac:TaxTotal">
		...
		<xsl:variable name="sumMontoTributo1000Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1000']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo1016Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='1016']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo2000Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='2000']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo9995Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9995']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo9996Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9996']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo9997Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9997']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo9998Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9998']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo9999Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='9999']/cbc:TaxAmount )"/>
		<xsl:variable name="sumMontoTributo7152Linea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID='7152']/cbc:TaxAmount )"/>
		...
		<xsl:variable name="sumMontoCargoDescuento00Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='00']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento01Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='01']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento02Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='02']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento03Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='03']/cbc:Amount)"/>	
		<xsl:variable name="sumMontoCargoDescuento04Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='04']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento05Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='05']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento06Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='06']/cbc:Amount)"/>			
		<xsl:variable name="sumMontoCargoDescuento47Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='47']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento48Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='48']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento49Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='49']/cbc:Amount)"/>
		<xsl:variable name="sumMontoCargoDescuento50Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='50']/cbc:Amount)"/>	
		<xsl:variable name="sumMontoCargoDescuento51Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='51']/cbc:Amount)"/>	
		<xsl:variable name="sumMontoCargoDescuento52Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='52']/cbc:Amount)"/>	
		<xsl:variable name="sumMontoCargoDescuento53Linea" select="sum(cac:DebitNoteLine/cac:AllowanceCharge[cbc:AllowanceChargeReasonCode='53']/cbc:Amount)"/>	
...
<!-- 				</xsl:when>	 -->
			...
			<xsl:if test="($fasefechaEmision2018 = 0) ">
				<xsl:if test="($t2 &gt; 7)">	
					<xsl:call-template name="rejectCall">
						...
						<xsl:with-param name="errorMessage" 
							select="concat('Error ', $fasefechaEmision2018, ') ', $cbcIssueDate, ' - ', $currentdate, ' - ', $t1, ' - ', $t2, ' - ', $t4, ' - ', $t6)" />
					</xsl:call-template>
				</xsl:if>	
			</xsl:if>
			...
			<xsl:if test="($fasefechaEmision2018 = 2)">
				<xsl:if test="($t2 &gt; 1)">	
					<xsl:call-template name="rejectCall">
						<xsl:with-param name="errorCode" select="'2108'" />
						<xsl:with-param name="errorMessage" 
							select="concat('Error ', $fasefechaEmision2018, ') ', $cbcIssueDate, ' - ', $currentdate, ' - ', $t1, ' - ', $t2, ' - ', $t3, ' - ', $t4, ' - ', $t5, ' - ', $t6)" />
					</xsl:call-template>
				</xsl:if>	
			</xsl:if>												
		</xsl:if>			
		...
		<!-- 6. Código de tipo de nota de débito -->
		<xsl:variable name="countCodigoTipoNotaDebito" select="count($codigoTipoNotaDebito)" />
		<xsl:if test="($countCodigoTipoNotaDebito = 0)">
			<xsl:call-template name="rejectCall">
				<xsl:with-param name="errorCode" select="'2128'" />
				<xsl:with-param name="errorMessage" 
					select="concat('Error en la linea: ', $countCodigoTipoNotaDebito)" />
			</xsl:call-template>
		</xsl:if>
		
		<xsl:if test="($countCodigoTipoNotaDebito &gt; 1)">
			<xsl:call-template name="rejectCall">
		...
		<xsl:for-each select="cac:DiscrepancyResponse">	
			...
			<xsl:call-template name="regexpValidateElementIfExist">
				...
				<xsl:with-param name="node" select="$codigoTipoNotaDebito" />
				<xsl:with-param name="regexp" select="'^(01|02|03|11|12)$'" />
				<xsl:with-param name="descripcion" 
					select="concat('Error en la linea: ', $codigoTipoNotaDebito)"/>
			</xsl:call-template>
...
<!-- 						<xsl:with-param name="isError" select="false()"/> -->
		...
		<xsl:if test="not($codigoTipoNotaDebito='03') and ($countInvoiceDocumentReference = 0)">
			<xsl:call-template name="rejectCall">
				<xsl:with-param name="errorCode" select="'2524'" />
				<xsl:with-param name="errorMessage" 
					select="concat('Error en la linea: ',$codigoTipoNotaDebito, ' ', $countInvoiceDocumentReference)" />
			</xsl:call-template>
		</xsl:if>
		
		<xsl:if test="($codigoTipoNotaDebito='11') and ($countInvoiceDocumentReference &gt; 1)">
			<xsl:call-template name="rejectCall">
			...
			<xsl:for-each select="./cac:InvoiceDocumentReference">						
				...
				<xsl:if test="($tipoDocumentoDelDocumentoModifica='01')">
					<xsl:call-template name="existAndRegexpValidateElement">
						...
						<xsl:with-param name="descripcion" 
							select="concat('Error en la linea 2: ', $codigoTipoNotaDebito,' ', $tipoDocumentoDelDocumentoModifica,' ', $serieNumeroDocumentoModifica)"/>
					</xsl:call-template>
				</xsl:if>				
				...
				<xsl:if test="($tipoDocumentoDelDocumentoModifica='03')">
					<xsl:call-template name="existAndRegexpValidateElement">
						...
						<xsl:with-param name="descripcion" 
							select="concat('Error en la linea 3: ', $codigoTipoNotaDebito,' ', $tipoDocumentoDelDocumentoModifica,' ', $serieNumeroDocumentoModifica)"/>
					</xsl:call-template>
				</xsl:if>
				...
				<!-- 19. Tipo de documento del documento que modifica -->							
				<xsl:if test="not($codigoTipoNotaDebito = '03') and ($sNDM1C='F')">					
					<xsl:call-template name="regexpValidateElementIfExist">
						<xsl:with-param name="errorCodeValidate" select="'2204'" />
						<xsl:with-param name="node" select="$tipoDocumentoDelDocumentoModifica" />
						<xsl:with-param name="regexp" select="'^(01|05|06|12|13|15|16|18|21|28|30|34|37|42|43|45|55|11|17|23|24|56)$'" />
						<xsl:with-param name="descripcion" 
							select="concat('Error en la linea: ', $codigoTipoNotaDebito, ' ', $sNDM1C, ' ', $tipoDocumentoDelDocumentoModifica)"/>
					</xsl:call-template>
				</xsl:if>
				
				<xsl:if test="($codigoTipoNotaDebito = '03') and ($sNDM1C='F')">					
					<xsl:call-template name="regexpValidateElementIfExist">
						<xsl:with-param name="errorCodeValidate" select="'2204'" />
						<xsl:with-param name="node" select="$tipoDocumentoDelDocumentoModifica" />
						<xsl:with-param name="regexp" select="'^(01|05|06|12|13|15|16|18|21|28|30|34|37|42|43|45|55|11|17|23|24|56||-)$'" />
				...
				<xsl:if test="not($codigoTipoNotaDebito = '03') and ($sNDM1C='B')">
					<xsl:call-template name="regexpValidateElementIfExist">
				...
				<xsl:if test="($codigoTipoNotaDebito = '03') and ($sNDM1C='B')">
					<xsl:call-template name="regexpValidateElementIfExist">
						<xsl:with-param name="errorCodeValidate" select="'2400'" />
						<xsl:with-param name="node" select="$tipoDocumentoDelDocumentoModifica" />
						<xsl:with-param name="regexp" select="'^(03|12|16|55||-)$'" />
				...
				<xsl:if test="not($codigoTipoNotaDebito='03') and (($sNDM1C = '0') or ($sNDM1C = '1') or ($sNDM1C = '2') or 
				...
				<xsl:if test="($codigoTipoNotaDebito='03') and (($sNDM1C = '0') or ($sNDM1C = '1') or ($sNDM1C = '2') or 
						($sNDM1C = '3') or ($sNDM1C = '4') or ($sNDM1C = '5') or ($sNDM1C = '6') or ($sNDM1C = '7') or 
						($sNDM1C = '8') or ($sNDM1C = '9'))">
					<xsl:call-template name="regexpValidateElementIfExist">
						<xsl:with-param name="errorCodeValidate" select="'2594'" />
...
<!-- 					<xsl:with-param name="regexp" select="'^[T][A-Z0-9]{3}-[0-9]{1,8}$|^[0-9]{4}-[0-9]{1,8}$|^[EG]{2}[0-9]{2}-[0-9]{1,8}$|^[G]{1}[0-9]{3}-[0-9]{1,8}$'"/> -->
				...
				<xsl:call-template name="regexpValidateElementIfExist">
					...
					<xsl:with-param name="isError" select="false()"/>
					<xsl:with-param name="descripcion" 
						select="concat('Error en la linea: 3) ', position(), ' ', $tipoGuiaRemisionRelacionada_ListURI)"/>
				</xsl:call-template>
			</xsl:if>
		...
		<xsl:for-each select="cac:AdditionalDocumentReference">		
			...
			<xsl:if test="$numeroOtroDocumentoRelacionada">
				...
				<!-- 21. Tipo de documento -->		
				<xsl:if test="not(($tipoOtroDocumentoRelacionada = '04') or ($tipoOtroDocumentoRelacionada = '05') or 
				...
				<xsl:call-template name="regexpValidateElementIfExist">
					...
					<xsl:with-param name="isError" select="false()"/>
					<xsl:with-param name="descripcion" 
						select="concat('Error en la linea: 4) ', position(), ' ', $tipoOtroDocumentoRelacionada_ListURI)"/>
				</xsl:call-template>								
			</xsl:if>
		...
		<xsl:variable name="countTaxTotalLine" select="count(cac:DebitNoteLine/cac:TaxTotal)"/>	
		...
		<xsl:if
			...
			<xsl:call-template name="rejectCall">
				...
				<xsl:with-param name="errorMessage"
					...
					' | ', $sumMontoBase1000Linea, ' ', $sumMontoBase1016Linea, ' ', $sumMontoBase9995Linea, ' ', $sumMontoBase9996Linea, ' ', $sumMontoBase9997Linea, ' ', $sumMontoBase9998Linea)"/>
			</xsl:call-template>
		</xsl:if>	
...
<!-- 								</xsl:call-template> -->
						...
						<!-- 39 / 41 - 43 / 44 . Código de tributo codigoTipoNotaDebito -->												
						<xsl:if test="($codigoTipoNotaDebito='12') and ($sumTotalValor1000Global &gt; 0)">		
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'3107'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', position(), ' ', $codigoTipoNotaDebito, ' ', $sumTotalValor1000Global)"/>
							</xsl:call-template>																
						</xsl:if>	
						
						<xsl:if test="($codigoTipoNotaDebito='11') and (($sumTotalValor1000Global &gt; 0) or ($sumTotalValor1016Global &gt; 0))">		
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'3107'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', position(), ' ', $codigoTipoNotaDebito, ' ', $sumTotalValor1016Global)"/>
							</xsl:call-template>																
						</xsl:if>							
						
						<xsl:if test="($codigoTipoNotaDebito='11') and (($sumTotalValor2000Global &gt; 0) or ($sumTotalValor9999Global &gt; 0))">		
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'3107'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', position(), ' ', $codigoTipoNotaDebito, ' ', $sumTotalValor2000Global)"/>
							</xsl:call-template>																
						</xsl:if>	
						
						<xsl:if test="($codigoTipoNotaDebito='12') and (($sumTotalValor9995Global &gt; 0) or ($sumTotalValor9997Global &gt; 0) or ($sumTotalValor9998Global &gt; 0))">		
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'3221'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', position(), ' ', $codigoTipoNotaDebito, ' ', $sumTotalValor9995Global, ' ', $sumTotalValor9997Global, ' ', $sumTotalValor9998Global)"/>
							</xsl:call-template>																
						</xsl:if>	
						
						<xsl:if test="($codigoTipoNotaDebito='11') and (($sumTotalValor9997Global &gt; 0) or ($sumTotalValor9998Global &gt; 0))">		
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'3221'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', position(), ' ', $codigoTipoNotaDebito, ' ', $sumTotalValor9997Global, ' ', $sumTotalValor9998Global)"/>
							</xsl:call-template>																
						</xsl:if>							
		...
		<!-- CALCULOS -->		
	    <xsl:variable name="totalBaseIGVxLinea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '1000']]/cbc:TaxableAmount)"/>
	    <xsl:variable name="totalBaseIVAPxLinea" select="sum(cac:DebitNoteLine/cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cac:TaxScheme/cbc:ID[text() = '1016']]/cbc:TaxableAmount)"/>
		...
		<!-- 30. Valor de venta por ítem -->
		<xsl:variable name="sumValorVentaItem1000For" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='1000']/cbc:LineExtensionAmount)"/>	
		<xsl:variable name="sumValorVentaItem1016For" select="sum(cac:DebitNoteLine[cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cac:TaxScheme/cbc:ID='1016']/cbc:LineExtensionAmount)"/>	
		...
		<xsl:if test="($tipoDocumentoDocumentoModificaGlobal = '01') and
			...
			<!-- <xsl:variable name="totalImporteCalculado" select="$totalBaseIGVxLinea * number($porcentajeIGV)"/>	 -->
			<xsl:variable name="totalImporteCalculado" select="$totalBaseIGVxLinea * number($porcentajeIGVVigenteLineaDecimal)"/>		
			<xsl:variable name="dif_TotalImporte_1" select="$sumatoriaIGV - $totalImporteCalculado" />
			...
			<xsl:if test="($dif_TotalImporte &lt; -1) or ($dif_TotalImporte &gt; 1)">
				<xsl:call-template name="rejectCall">
					...
					<xsl:with-param name="errorMessage"
						select="concat('Error en la linea: ', $dif_TotalImporte, ' ', $sumatoriaIGV, ' ', $totalImporteCalculado, ' ', $totalBaseIGVxLinea, ' ', $porcentajeIGVVigenteLineaDecimal)"/>
				</xsl:call-template>				
			</xsl:if>	
		</xsl:if>	
...
<!-- 				</xsl:call-template> -->
		...
		<xsl:for-each select="cac:DebitNoteLine">
			...
			<xsl:variable name="unidadMedidaLinea" select="./cbc:DebitedQuantity/@unitCode"/>	
			<!-- 24. Cantidad de unidades por ítem -->	
			<xsl:variable name="cantidadUnidadesLinea" select="./cbc:DebitedQuantity"/>
			<xsl:variable name="cantidadUnidadesLinea_UnitCodeListID" select="./cbc:DebitedQuantity/@unitCodeListID"/>
			<xsl:variable name="cantidadUnidadesLinea_UnitCodeListAgencyName" select="./cbc:DebitedQuantity/@unitCodeListAgencyName"/>			
...
<!-- 						<xsl:with-param name="regexp" select="'^(?!\s*$)[^\s].{2,499}$'"/> -->
				...
				<xsl:for-each select="./cac:CommodityClassification">
					...
					<!-- 26. Codigo producto de SUNAT -->
					<xsl:if test="($codigoTipoNotaDebito='11')">
						<xsl:call-template name="existValidateElementNotExist">
				...
				<xsl:for-each select="./cac:StandardItemIdentification">
					...
					<xsl:if test="($codigoProductoGS1_schemeID='GTIN-8') and not($lengthCodigoProductoGS1=8)">	
						<xsl:call-template name="addWarning">
							<xsl:with-param name="warningCode" select="'4334'" />
							<xsl:with-param name="warningMessage"
								select="concat('Error en la linea 1: ', position(), ' ', $codigoProductoGS1_schemeID, ' ', $lengthCodigoProductoGS1)"/>
						</xsl:call-template>									
<!--						<xsl:call-template name="rejectCall">-->
<!--							<xsl:with-param name="errorCode" select="'4334'" />-->
<!--							<xsl:with-param name="errorMessage"-->
<!--								select="concat('Error en la linea 1: ', position(), ' ', $codigoProductoGS1_schemeID, ' ', $lengthCodigoProductoGS1)"/>-->
<!--						</xsl:call-template>-->
					</xsl:if>
					
					<xsl:if test="($codigoProductoGS1_schemeID='GTIN-12' and not($lengthCodigoProductoGS1=12))">										
						<xsl:call-template name="addWarning">
							<xsl:with-param name="warningCode" select="'4334'" />
							<xsl:with-param name="warningMessage"
...
<!-- 						</xsl:call-template> -->
					...
					<xsl:if test="($codigoProductoGS1_schemeID='GTIN-14' and not($lengthCodigoProductoGS1=14))">										
						<xsl:call-template name="addWarning">
							<xsl:with-param name="warningCode" select="'4334'" />
							<xsl:with-param name="warningMessage"
								select="concat('Error en la linea 4: ', position(), ' ', $codigoProductoGS1_schemeID, ' ', $lengthCodigoProductoGS1)"/>
						</xsl:call-template>	
<!-- 						<xsl:call-template name="rejectCall"> -->
<!-- 							<xsl:with-param name="errorCode" select="'4334'" /> -->
<!-- 							<xsl:with-param name="errorMessage" -->
...
<!-- 						</xsl:call-template> -->
			...
			<xsl:for-each select="./cac:Price">
				...
				<xsl:if test="($montoTributoLinea9996Linea &gt; 0) and ($valorUnitarioItem &gt; 0)">
					<xsl:call-template name="rejectCall">
						<xsl:with-param name="errorCode" select="'2640'" />
						<xsl:with-param name="errorMessage"
							select="concat('Error en la linea: ', position(), ' ', $montoTributoLinea9996Linea, ' ',$valorUnitarioItem)" />
					</xsl:call-template>
				</xsl:if>					
			...
			<xsl:for-each select="./cac:PricingReference">
				<xsl:for-each select="./cac:AlternativeConditionPrice">
					...
					<xsl:if test="($tipoDocumentoDocumentoModificaGlobal = '01') and not($sumMontoBase9996LineaSub &gt; 0) ">	
						<xsl:variable name="totalCalculado" select="number($valorVentaLinea) + number($montoTotalTributosLinea)"/>	
						...
						<xsl:if test="($dif_TotalImporte &lt; -1) or ($dif_TotalImporte &gt; 1)">
							<xsl:call-template name="rejectCall">
								...
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', $dif_TotalImporte, ' ', $precioVentaUnitarioItem, ' ', $totalImporteCalculado,' ', $valorVentaLinea, ' ',$montoTotalTributosLinea, ' ',$cantidadUnidadesLinea)"/>
							</xsl:call-template>
						</xsl:if>	
					</xsl:if>			
					...
					<xsl:call-template name="regexpValidateElementIfExist">
						...
						<xsl:with-param name="isError" select="false()"/>
						<xsl:with-param name="descripcion" 
							select="concat('Error en la linea: 5) ', position(), ' ', $codigoTipoPrecioItem_ListURI)"/>
					</xsl:call-template>							
				</xsl:for-each>					
			</xsl:for-each>
			...
			<xsl:for-each select="./cac:TaxTotal">			
				...
				<xsl:for-each select="./cac:TaxSubtotal">	
					...
					<xsl:for-each select="./cac:TaxCategory">
						...
						<xsl:if test="($montoBase &gt; 0) and ($codigoTipoNotaDebito = '11') and not($afectacionIGVLinea = '40')">	
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'2642'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', position(), ' ' , $montoBase, ' ', $codigoTipoNotaDebito, ' ', $afectacionIGVLinea)"/>
							</xsl:call-template>
						</xsl:if>	
							
						<!-- ////  -->
						<!--
						<xsl:if test="($codigoTipoNotaDebito = '12') and not($afectacionIGVLinea = '17')">	
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'2644'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', $numeroLinea, ') ', $codigoTipoNotaDebito, ' ', $afectacionIGVLinea)"/>
							</xsl:call-template>
						</xsl:if>	
						-->
						
						<xsl:if test="($codigoTipoNotaDebito = '12') and ($afectacionIGVLinea = '')">	
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'2644'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', $numeroLinea, ') ', $codigoTipoNotaDebito, ' ', $afectacionIGVLinea)"/>
						...
						<xsl:if test="not($codigoTipoNotaDebito = '12') and ($afectacionIGVLinea = '17')">	
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'3230'" />
								<xsl:with-param name="errorMessage"
									select="concat('Error en la linea: ', position(), ' ', $codigoTipoNotaDebito, ' ', $afectacionIGVLinea)"/>
							</xsl:call-template>
						</xsl:if>													
						...
						<xsl:call-template name="regexpValidateElementIfExist">
							...
							<xsl:with-param name="isError" select="false()"/>
							<xsl:with-param name="descripcion" 
								select="concat('Error en la linea: 6) ', position(), ' ', $afectacionIGVLinea_ListURI)"/>
						</xsl:call-template>					
						...
						<xsl:for-each select="./cac:TaxScheme">						
							...
							<xsl:if test="(($codigoTributoLinea = '9995') or ($codigoTributoLinea = '9997') or ($codigoTributoLinea = '9998'))">	
								<xsl:if test="not($tasaIGV = 0)">
									<xsl:call-template name="rejectCall">
										<xsl:with-param name="errorCode" select="'3101'" />
										<xsl:with-param name="errorMessage"
											select="concat('Error en la linea: ', position(), ' ' , $codigoTributoLinea, ' ', $tasaIGV)"/>
									</xsl:call-template>
								</xsl:if>
							</xsl:if>	
							...
							<xsl:if test="($tipoDocumentoDocumentoModificaGlobal = '01')">
								<xsl:if test="((($codigoTributoLinea = 1000) and ($montoBase > 0)) or 
										...
										(($afectacionIGVLinea='11') or ($afectacionIGVLinea='12') or ($afectacionIGVLinea='13') or
										($afectacionIGVLinea='14') or ($afectacionIGVLinea='15') or ($afectacionIGVLinea='16'))))">						
									<xsl:if test="not(number($tasaIGV) = number($porcentajeIGVVigenteLinea))">	
										<xsl:call-template name="rejectCall">
											<xsl:with-param name="errorCode" select="'3462'" />
											<xsl:with-param name="errorMessage"
												select="concat('Error en la linea: ', position(), ' | ', $codigoTributoLinea, ' | ', $tasaIGV, ' | ', $porcentajeIGVVigenteLinea)"/>
										</xsl:call-template>																																															
									</xsl:if>
								</xsl:if>							
							</xsl:if>
...
<!--										<xsl:call-template name="addWarning">-->
<!--											<xsl:with-param name="warningCode" select="'4438'" />-->
<!--											<xsl:with-param name="warningMessage"-->
<!--												select="concat('Error en la linea: ', position(), ' | ', $codigoTributoLinea, ' | ', $tasaIGV, ' | ', $porcentajeIGVVigenteLinea)"/>-->
<!--										</xsl:call-template>																																														-->
									</xsl:if>
							...
							<xsl:if test="(($codigoTributoLinea = 1000) and  (number($tasaIGV) = 10))">							
								<xsl:if test="not(number($tasaIGV) = number($porcentajeIGVVigente))">	
									<xsl:call-template name="addWarning">
										<xsl:with-param name="warningCode" select="'4439'" />
										<xsl:with-param name="warningMessage"
											select="concat('Error en la linea: ', position(), ' | ', $codigoTributoLinea, ' | ', $tasaIGV, ' | ', $porcentajeIGVVigente)"/>
									</xsl:call-template>																																						
								</xsl:if>	
							</xsl:if>		
	
							<xsl:if test="not($tasaIGV = 0) and ($codigoTributoLinea = '11') and ($codigoTributoLinea = '40')">	
								<xsl:call-template name="rejectCall">
									<xsl:with-param name="errorCode" select="'2642'" />
									<xsl:with-param name="errorMessage"
										select="concat('Error en la linea: ', position(), ' ' , $montoBase, ' ', $codigoTipoNotaDebito, ' ', $afectacionIGVLinea)"/>
							...
							<!-- 32. Monto base IGV/IVAP -->
							<xsl:if test="($codigoTributoLinea = '1016') and ($montoBase = 0) and ($codigoTipoNotaDebito = '12')">	
								<xsl:call-template name="rejectCall">
									<xsl:with-param name="errorCode" select="'2643'" />
									<xsl:with-param name="errorMessage"
										select="concat('Error en la linea: ', position(), ' ', $codigoTributoLinea, ' ', $montoBase, ' ', $codigoTipoNotaDebito)"/>
								</xsl:call-template>
							</xsl:if>							
				...
				<xsl:if test="($tipoDocumentoDocumentoModificaGlobal = '01') and ($baseISCxLinea = 0)">
			    	<xsl:if test="(($countTributoLinea_1000 &gt; 0) or ($countTributoLinea_1016 &gt; 0))">							
						...
						<xsl:if test="($dif_BaseISCLinea &lt; -0.0001) or ($dif_BaseISCLinea &gt; 0.01)">
							<xsl:call-template name="rejectCall">
								<xsl:with-param name="errorCode" select="'3272'" />
								<xsl:with-param name="errorMessage"
			...
			<xsl:for-each select="./cac:Item">
				<xsl:for-each select="./cac:AdditionalItemProperty">
					...
					<xsl:call-template name="regexpValidateElementIfExist">
						...
						<xsl:with-param name="isError" select="false()"/>
						<xsl:with-param name="descripcion" 
							select="concat('Error en la linea: 7) ', position(), ' ', $codigoConcepto_listURI)"/>
					</xsl:call-template>	
				   ...
				   <xsl:if test="$codigoConcepto = '7004'">
					...
					<!-- 58. Suma asegurada / alcance de cobertura o monto  -->
				   	...
				   	<xsl:for-each select="./cac:UsabilityPeriod">	
						...
						<xsl:if test="($codigoConcepto='7014')">							
							...
							<xsl:call-template name="regexpValidateElementIfExist">
								...
								<xsl:with-param name="isError" select="false()"/>
								<xsl:with-param name="descripcion" 
									select="concat('Error en la linea: 11) ', position(), ' ', $codigoConcepto, ' ', $fechaInicio)"/>
							</xsl:call-template>
							...
							<xsl:call-template name="regexpValidateElementIfExist">
								...
								<xsl:with-param name="isError" select="false()"/>
								<xsl:with-param name="descripcion" 
									select="concat('Error en la linea: 12) ', position(), ' ', $codigoConcepto, ' ', $fechaFin)"/>
							</xsl:call-template>								
						</xsl:if>															       
			      	</xsl:for-each>				      			      
				</xsl:for-each>	
		...
		<xsl:for-each select="cac:RequestedMonetaryTotal">
...
<!-- 					</xsl:call-template>				 -->
		...
		<xsl:variable name="countPaymentMeansDetraccion" select="count(cac:PaymentMeans/cbc:ID[text()='Detraccion'])" />
		<xsl:for-each select="cac:PaymentTerms">		
			<!-- 61. Indicador PaymentTerms -->
			<xsl:variable name="indicadorPaymentTerms" select="./cbc:ID" />		
			<!-- 61. Código de bien o servicio -->
			...
			<xsl:if test="($indicadorPaymentTerms = 'Detraccion')">
				<xsl:if test="($countPaymentMeansDetraccion = 0)">
					<xsl:call-template name="rejectCall">
						<xsl:with-param name="errorCode" select="'3313'" />
						<xsl:with-param name="errorMessage"
							select="concat('Error en la linea ', $indicadorPaymentTerms, ' - ', $countPaymentMeansDetraccion)"/>
					</xsl:call-template>
				</xsl:if>				
		...
		<xsl:variable name="countPaymentTermsDetraccion" select="count(cac:PaymentTerms/cbc:ID[text()='Detraccion'])" />		
		<xsl:for-each select="cac:PaymentMeans">			
			<!-- 62. Indicador PaymentMeans -->
			...
			<xsl:if test="($indicadorPaymentMeans='Detraccion')">
				<xsl:if test="($countPaymentTermsDetraccion = 0)">
					<xsl:call-template name="rejectCall">
						<xsl:with-param name="errorCode" select="'3314'" />
						<xsl:with-param name="errorMessage"
							select="concat('Error en la linea ', $indicadorPaymentMeans, ' - ', $countPaymentTermsDetraccion)"/>
					</xsl:call-template>
				</xsl:if>				

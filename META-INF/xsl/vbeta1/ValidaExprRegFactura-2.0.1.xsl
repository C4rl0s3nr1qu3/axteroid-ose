...
<!-- 					<xsl:with-param name="warningMessage" -->
<!-- 						select="concat('Error en la linea: ', $dif_TotalImporte, ' ', $sumatoriaIGV, ' ', $totalImporteCalculado, ' ', $totalBaseIGVxLinea, ' ', $sumatoriaDescuentosGlobales, ' ', $sumatoriaCargosGobales_49)"/> -->
<!-- 				</xsl:call-template> -->
			</xsl:if>
	    </xsl:if>
...
<!-- 					<xsl:with-param name="warningMessage" -->
<!-- 						select="concat('Error en la linea: ', $dif_TotalImporte, ' ', $sumatoriaIVAP, ' ', $totalImporteCalculado, ' ', $sumatoriaBaseIVAP, ' ', $sumatoriaDescuentosGlobales, ' ', $sumatoriaCargosGobales_49)"/> -->
<!-- 				</xsl:call-template> -->
			</xsl:if>
	    </xsl:if>
...
<!-- 			<xsl:variable name="sumaTotalPrecioVenta" select="$sumatoriaBaseIGV + $sumatoriaBaseEXPOR + $sumatoriaBaseEXONE + $sumatoriaBaseINAFE + $sumatoriaISC + $sumatoriaOtrosTributos + $sumatoriaICBPER"/>		 -->
...
<!-- 				</xsl:call-template> -->
		...
		<xsl:if test="($sumatoriaTotalPrecioVentaSubTotal) and ($countCodigoTributo1016 &gt; 0)">
<!-- 			<xsl:variable name="sumaTotalPrecioVenta" select="$sumatoriaBaseIGV + $sumatoriaBaseEXPOR + $sumatoriaBaseEXONE + $sumatoriaBaseINAFE + $sumatoriaOtrosTributos + $sumatoriaICBPER"/>	 -->

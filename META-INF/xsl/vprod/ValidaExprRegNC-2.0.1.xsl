...
<!-- 				</xsl:call-template> -->
		...
		<xsl:variable name="porcentajeIGVVigenteLinea" select="sum(cac:CreditNoteLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory[cac:TaxScheme/cbc:ID[text() = '1000' or text() = '9996']]/cbc:Percent)"/>

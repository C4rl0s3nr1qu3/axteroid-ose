...
public class Documento implements Serializable {
    ...
    @Column(name = "RUC_PSE_EMISOR")
    private Long rucPseEmisor;
    @Basic(optional = false)
...
//    public TbContent getIdContent() {
//        return idContent;
//    }
//
//    public void setIdContent(TbContent idContent) {
...
//    }
	...
	public Long getRucPseEmisor() {
		return rucPseEmisor;
	}

	public void setRucPseEmisor(Long rucPseEmisor) {
		this.rucPseEmisor = rucPseEmisor;
	}
	...
	public String toString() {
		return "Documento [id=" + id + ", rucEmisor=" + rucEmisor + ", tipoDocumento=" + tipoDocumento
				+ ", serie=" + serie + ", numeroCorrelativo=" + numeroCorrelativo + ", correlativo=" + correlativo + "]";
	}

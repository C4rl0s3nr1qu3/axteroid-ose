...
@Embeddable
public class SunatAutorizacionComprobPagoFisicoPK implements Serializable {
    ...
    public SunatAutorizacionComprobPagoFisicoPK() {
    }

    public SunatAutorizacionComprobPagoFisicoPK(long numRuc, String codCpe, String numSerieCpe, int numIniCpe) {
        this.numRuc = numRuc;
        this.codCpe = codCpe;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SunatAutorizacionComprobPagoFisicoPK)) {
            return false;
        }
        SunatAutorizacionComprobPagoFisicoPK other = (SunatAutorizacionComprobPagoFisicoPK) object;
	...
	public String toString() {
		return "SunatAutorizacionComprobPagoFisicoPK [numRuc=" + numRuc + ", codCpe=" + codCpe + ", numSerieCpe="

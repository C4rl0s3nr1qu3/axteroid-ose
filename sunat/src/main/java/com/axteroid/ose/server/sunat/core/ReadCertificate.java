...
public class ReadCertificate {
	...
	public void validarCertificate(Object o) {
		try {
			log.info("0) *********************************************************** "); 
			//log.info("X509Certificate.getEncoded: {}",((X509Certificate)o).getEncoded());
			log.info("X509Certificate.getEncoded: {}",this.base64EncodeBase64String(((X509Certificate)o).getEncoded(),""));
            log.info("1) *********************************************************** "); 
            ...
            log.info("X509Certificate.getSignature: {}",this.base64EncodeBase64String(((X509Certificate)o).getSignature(),""));
            ...
            this.base64EncodeBase64String(((X509Certificate)o).getSignature(), "getSignature");
...
/*            }else if (ans instanceof X500Name){
            ...
            this.base64EncodeBase64String(tbscs.getEncoded(), "tbscs.getEncoded()");                       
            this.base64EncodeBase64String(tbs, "X509Certificate");
	...
	private void getExtensionValue(Object o, String str) throws IOException {
    	...
    	if (id != null){
            ...
            this.base64EncodeBase64String(id, str);
...
//	}
	...
	private String base64EncodeBase64String(byte[] text, String etiqueta) {
		 return etiqueta+" | "+org.apache.commons.codec.binary.Base64.encodeBase64String(text);
	}	

...
public class NcCrypt { 
	private final static Logger log = LoggerFactory.getLogger(NcCrypt.class);
	
	public static String encriptarPassword(String strpassword) {
        String strkey= Constantes.OSE_NcCrypt.toLowerCase();
        //log.info("{} - {}",ConstantesOse.OSE_NcCrypt,strkey);       
    ...
    public static synchronized String decrypt(String s, String s1){
        ...
        try{
        	...
        	log.info("%3DES-F-CIPHERINIT; Exception caught while initializing the cipher object.");
        	log.info("; " + exception1.toString());
            return null;
        }
    ...
    public static synchronized String encrypt(String s, String s1) {
        ...
        try {       	
            ...
            log.info("%3DES-F-CIPHERINIT; Exception caught while initializing the cipher object.");
            log.info("exception: /n" + exception.toString());
            return null;
        }
        String s2 = null;
...
//    	listCadena.add("Jksoseb3zl3nks.");
    	...
    	//String cadena = "x'4668566870454E4463446849477A5537546C78326339536A6169613271654F62'";
    	//ncCrypt.getListDesencript(cadena);
    }
	...
	public void getListDesencript(String cadena) {				

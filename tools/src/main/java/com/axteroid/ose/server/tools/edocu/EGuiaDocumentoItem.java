...
public class EGuiaDocumentoItem {
    /**
     * parametro
     * cac:DespatchLine/cac:OrderLineReference/cbc:ID
     */
     ...
     */
    @NotNull(message="7314")
    public BigDecimal cantidad=BigDecimal.ZERO;

    /**
     * parametro
     * cac:DespatchLine/cbc:DeliveredQuantity@unitCode
     */
    @NotBlank(message="7315")
...
//    public String buildCantidadyUM() {
//        if (StringUtils.isBlank(unidadMedida) ||
//        		cantidad == null) return null;
//        return unidadMedida + "|" + NumberUtil.toFormat(cantidad);
//    }
}

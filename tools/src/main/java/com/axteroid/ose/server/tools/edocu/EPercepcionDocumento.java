...
public class EPercepcionDocumento implements IDocumento, IEDocumento {
    ...
    public String serieNumeroPercepcion;
    ...
    public String ubigeoCliente;
    public String direccionCliente;
    public String urbanizacionCliente;
    public String provinciaCliente;
    public String departamentoCliente;
    public String distritoCliente;
    public String codigoPaisCliente;
    public String razonSocialCliente;
    public String regimenPercepcion;
    public BigDecimal tasaPercepcion;
	public String observaciones;
	public BigDecimal importeTotalPercibido;
	public String tipoMonedaTotalPercibido;
	public BigDecimal importeTotalCobrado;
	public String tipoMonedaTotalCobrado;
    public List<EPercepcionDocumentoItem> items = new ArrayList<EPercepcionDocumentoItem>();
    ...
    private String indicadorEmisiónExcepcional;
...
//    private String textoAuxiliar250_10;	
	...
	public String getSerieNumeroPercepcion() {
		return serieNumeroPercepcion;
	}

	public void setSerieNumeroPercepcion(String serieNumeroPercepcion) {
		this.serieNumeroPercepcion = serieNumeroPercepcion;
	}
	...
	public String getUrbanizacionCliente() {
		return urbanizacionCliente;
	}

	public void setUrbanizacionCliente(String urbanizacionCliente) {
		this.urbanizacionCliente = urbanizacionCliente;
	}
	...
	public BigDecimal getImporteTotalPercibido() {
		return importeTotalPercibido;
	}

	public void setImporteTotalPercibido(BigDecimal importeTotalPercibido) {
		this.importeTotalPercibido = importeTotalPercibido;
	}

	public String getTipoMonedaTotalPercibido() {
		return tipoMonedaTotalPercibido;
	}

	public void setTipoMonedaTotalPercibido(String tipoMonedaTotalPercibido) {
		this.tipoMonedaTotalPercibido = tipoMonedaTotalPercibido;
	}

	public BigDecimal getImporteTotalCobrado() {
		return importeTotalCobrado;
	}

	public void setImporteTotalCobrado(BigDecimal importeTotalCobrado) {
		this.importeTotalCobrado = importeTotalCobrado;
	}

	public String getTipoMonedaTotalCobrado() {
		return tipoMonedaTotalCobrado;
	}

	public void setTipoMonedaTotalCobrado(String tipoMonedaTotalCobrado) {
		this.tipoMonedaTotalCobrado = tipoMonedaTotalCobrado;
	}

	public List<EPercepcionDocumentoItem> getItems() {
		return items;
	}

	public void setItems(List<EPercepcionDocumentoItem> items) {
		this.items = items;
	}
	...
	public void populateItem() {
        ...
        if (StringUtils.isBlank(getSerieNumeroPercepcion())) {
            setSerieNumeroPercepcion("SN" + new Date().getTime());
        }
	}

	public String getIdDocumento() {
		return getSerieNumeroPercepcion();
	}
...
/*	public String getHashCode() {
	...
	public String getTipoDocumentoAdquiriente() {
		return getTipoDocumentoCliente();
	}

	public String getNumeroDocumentoAdquiriente() {
		return getNumeroDocumentoCliente();
	}

	public String getRazonSocialAdquiriente() {
		return getRazonSocialCliente();
	}
    ...
    public String buildCliente() {
        if (StringUtils.isBlank(numeroDocumentoCliente) ||
                StringUtils.isBlank(tipoDocumentoCliente)) {
            return null;
        }
        return StringUtil.blank(numeroDocumentoCliente) + "|" + StringUtil.blank(tipoDocumentoCliente);
    }
    
    public String buildTotalPercibido(){
        if (StringUtils.isBlank(tipoMonedaTotalPercibido) ||
        		importeTotalPercibido == null) return null;
        return tipoMonedaTotalPercibido + "|" + NumberUtil.toFormat(importeTotalPercibido);
    }
    
    public String buildTotalCobrado(){
        if (StringUtils.isBlank(tipoMonedaTotalCobrado) ||
        		importeTotalCobrado == null) return null;
        return tipoMonedaTotalCobrado + "|" + NumberUtil.toFormat(importeTotalCobrado);
    }
...
//    }
	...
	public String getIndicadorEmisiónExcepcional() {
		return indicadorEmisiónExcepcional;
	}

	public void setIndicadorEmisiónExcepcional(String indicadorEmisiónExcepcional) {
		this.indicadorEmisiónExcepcional = indicadorEmisiónExcepcional;
	}

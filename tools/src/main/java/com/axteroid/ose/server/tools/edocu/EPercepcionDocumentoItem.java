...
public class EPercepcionDocumentoItem {
    ...
    public BigDecimal importePercibido;
    public String monedaImportePercibido;
    public Date fechaPercepcion;
    public BigDecimal importeTotalCobrar;
    public String monedaMontoTotalCobrar;
...
//    private String textoAuxiliar250_10;    
	...
	public BigDecimal getImporteTotalCobrar() {
		return importeTotalCobrar;
	}
	public void setImporteTotalCobrar(BigDecimal importeTotalCobrar) {
		this.importeTotalCobrar = importeTotalCobrar;
	}
	public String getMonedaMontoTotalCobrar() {
		return monedaMontoTotalCobrar;
	}
	public void setMonedaMontoTotalCobrar(String monedaMontoTotalCobrar) {
		this.monedaMontoTotalCobrar = monedaMontoTotalCobrar;
	}
    ...
    public String buildTotalCobro(){
        if (StringUtils.isBlank(monedaCobro) ||
        		importeCobro == null) return null;
        return monedaCobro + "|" + NumberUtil.toFormat(importeCobro);
    }   
    
    public String buildTotalPercibido(){
        if (StringUtils.isBlank(monedaImportePercibido) ||
        		importePercibido == null) return null;
        return monedaImportePercibido + "|" + NumberUtil.toFormat(importePercibido);
    }
    
    public String buildTotalCobrar(){
        if (StringUtils.isBlank(monedaMontoTotalCobrar) ||
        		importeTotalCobrar == null) return null;
        return monedaMontoTotalCobrar + "|" + NumberUtil.toFormat(importeTotalCobrar);
    }

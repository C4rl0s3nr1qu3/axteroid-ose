...
@XmlType(name = "Percepcion", propOrder = {
		...
		"tipoMonedaTotalPercibido",
		"importeTotalCobrado",
		"tipoMonedaTotalCobrado",
        "codigoAuxiliar100_1",
        "textoAuxiliar100_1",
        "codigoAuxiliar100_2",
        "textoAuxiliar100_2",
...
public class EPercepcionCliente implements Cloneable {
	...
	@XmlElement(name = "PercepcionItem", nillable = true)
	public List<EPercepcionItemCliente> items = new ArrayList<EPercepcionItemCliente>();
	...
	public List<EPercepcionItemCliente> getItems() {
		return items;
	}
	public void setItems(List<EPercepcionItemCliente> items) {
		this.items = items;
	}

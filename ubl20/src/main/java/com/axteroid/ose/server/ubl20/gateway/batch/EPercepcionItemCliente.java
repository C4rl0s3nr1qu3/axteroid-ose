...
@XmlType(name = "PercepcionItem", propOrder = {
        "indicador",
        "numeroOrdenItem",        
        "tipoDocumentoRelacionado",
        "numeroDocumentoRelacionado",
        "fechaEmisionDocumentoRelacionado",
        "importeTotalDocumentoRelacionado",
        "tipoMonedaDocumentoRelacionado",
        "fechaCobro",
        "numeroCobro",
        "importeCobro",
        "monedaCobro",
        "importePercibido",
        "monedaImportePercibido",
        "fechaPercepcion",
        "importeTotalCobrar",
        "monedaMontoTotalCobrar",
        "monedaReferenciaTipoCambio",
        "monedaObjetivoTasaCambio",
        "factorTipoCambioMoneda",
        "fechaCambio",
        "codigoAuxiliar100_1",
        "textoAuxiliar100_1",
        "codigoAuxiliar100_2",
...
public class EPercepcionItemCliente {
		
	public String indicador = "D";

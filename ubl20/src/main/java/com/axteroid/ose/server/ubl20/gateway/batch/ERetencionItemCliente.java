...
@XmlType(name = "RetencionItem", propOrder = {
        "indicador",
        "numeroOrdenItem",        
        ...
        "fechaPago",
        "numeroPago",
        "importePagoSinRetencion",
        "monedaPago",
        "importeRetenido",
        "monedaImporteRetenido",
        "fechaRetencion",
        "importeTotalPagarNeto",
        "monedaMontoNetoPagado",
...
public class ERetencionItemCliente {

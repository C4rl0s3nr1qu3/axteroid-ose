...
import com.axteroid.ose.server.ubl20.gateway.batch.EGuiaCliente;
...
@XmlRootElement(name = "SignOnLineDespatchCmd")
public class SignOnLineDespatchCmd extends ActionImpl {
    ...
    @Valid
    List<EGuiaCliente> documentos;

    public SignOnLineDespatchCmd() {
    }
    ...
    public List<EGuiaCliente> getDocumentos() {
        return documentos;
    }

    public void setDocumentos(List<EGuiaCliente> documentos) {

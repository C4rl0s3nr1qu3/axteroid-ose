...
import com.axteroid.ose.server.ubl20.gateway.batch.ERetencionCliente;
...
@XmlRootElement(name = "SignOnLineRetentionCmd")
public class SignOnLineRetentionCmd extends ActionImpl {
    ...
    @Valid
    List<ERetencionCliente> documentos;

    public SignOnLineRetentionCmd() {
    }
    ...
    public List<ERetencionCliente> getDocumentos() {
        return documentos;
    }

    public void setDocumentos(List<ERetencionCliente> documentos) {

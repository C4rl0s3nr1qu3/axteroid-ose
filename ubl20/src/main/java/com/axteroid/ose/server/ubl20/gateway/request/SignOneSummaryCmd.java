...
@XmlRootElement(name = "SignOneSummaryCmd")
public class SignOneSummaryCmd extends ActionImpl {
    ...
    public EResumenCliente getDocumento() {
        return documento;
    }

    public void setDocumento(EResumenCliente documento) {

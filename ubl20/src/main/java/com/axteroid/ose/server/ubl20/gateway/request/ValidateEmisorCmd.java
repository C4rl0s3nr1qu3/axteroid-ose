...
@XmlRootElement(name = "ValidateEmisorCmd")
public class ValidateEmisorCmd extends  ActionImpl  {

    public ValidateEmisorCmd() {
    }

    public ValidateEmisorCmd(String idEmisor) {

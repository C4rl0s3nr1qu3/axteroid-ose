...
public class InvoiceLineType implements IDocumentoItemSunat {
    ...
    @XmlElement(name = "Item", required = true, namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    public void insertTaxTotal(TaxTotalType value) {
    ...
    public void insertAllowanceCargo(AmountType amountType) {
    ...
    public void insertAllowanceDescuento(AmountType amountType) {
        if(amountType==null) return ;
        ChargeIndicatorType chargeIndicatorType = new ChargeIndicatorType();
    ...
    public List<ItemPropertyType> getItemPropertyTypeList() {
        return item.getAdditionalItemProperty();
    }

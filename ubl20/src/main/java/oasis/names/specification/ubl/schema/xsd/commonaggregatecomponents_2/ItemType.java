...
public class ItemType {
    ...
    public void insertDescriptionTypeList(List<DescriptionType> values) {
        if(values==null) return;
        getDescription().addAll(values);
    }
    public void insertSellersItemIdentification(ItemIdentificationType value) {
        if(value==null) return;
        setSellersItemIdentification(value);
    }
    ...
    public void insertAdditionalItemProperty(ItemPropertyType value){
        getAdditionalItemProperty().add(value);
    }

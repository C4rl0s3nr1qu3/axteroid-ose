...
public class PartyType {
    ...
    public void insertNameType(NameType partyNameType) {
    	if(partyNameType == null) {
    		return;
    	} else {
        	PartyNameType value = new PartyNameType();
        	value.setName(partyNameType);
            getPartyName().add(value);
    	}
    }
    
//    <FIX02
    public void insertPartyName(PartyNameType partyNameType){
...
//    FIX02>
    ...
    public void insertPartyLegalEntity(PartyLegalEntityType partyNameType) {
        getPartyLegalEntity().add(partyNameType);
    }    

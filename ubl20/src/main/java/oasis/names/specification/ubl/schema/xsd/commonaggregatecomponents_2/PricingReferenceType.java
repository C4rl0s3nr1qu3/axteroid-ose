...
public class PricingReferenceType {
    ...
    public void insertPriceType(PriceType value) {
        if(value==null) return;
/*
        if (value.getPriceTypeCode()!=null && value.getPriceTypeCode().getValue().equals("02")) {
            PriceType idType = new PriceType();
            PriceAmountType priceAmountType = new PriceAmountType();
            priceAmountType.setCurrencyID(value.getPriceAmount().getCurrencyID());
            priceAmountType.setValue(BigDecimal.ZERO);
            ...
            getAlternativeConditionPrice().add(idType);
        }
*/
        getAlternativeConditionPrice().add(value);
    }

...
@XmlType(name = "SUNATCarrierParty", propOrder = {
...
public class SunatCarrierPartyType {
    ...
    @XmlElement(name = "CustomerAssignedAccountID",namespace = MyNamespacePrefixMapper.CBC_URI)
    protected CustomerAssignedAccountIDType customerAssignedAccountID;

    @XmlElement(name = "AdditionalAccountID",namespace = MyNamespacePrefixMapper.CBC_URI)
    ...
    public void setAdditionalAccountID(AdditionalAccountIDType additionalAccountID) {
    ...
    public void setCustomerAssignedAccountID(CustomerAssignedAccountIDType customerAssignedAccountID) {

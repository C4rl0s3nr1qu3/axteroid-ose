...
public class SunatReferenceValueType {
    ...
    @XmlElement(name = "SUNATValueTravel",namespace = MyNamespacePrefixMapper.SAC_URI)
    protected SunatValueTravelType sunatValueTravel;
	...
	public SunatValueTravelType getSunatValueTravel() {
		if(sunatValueTravel == null) {
			sunatValueTravel = new SunatValueTravelType();
		}
		return sunatValueTravel;
	}

	public void setSunatValueTravel(SunatValueTravelType sunatValueTravel) {
		this.sunatValueTravel = sunatValueTravel;
	}
}

...
@XmlRootElement(name = "Invoice", namespace = MyNamespacePrefixMapper.URI)
public class InvoiceType implements IDocumentoSunat {
    ...
    public void setExpiryDate(ExpiryDateType expiryDate) {
    ...
    public void insertDespatchDocumentReference(DocumentReferenceType value){
        getDespatchDocumentReference().add(value);
    }

    public void insertAdditionalDocumentReference(DocumentReferenceType value){
        getAdditionalDocumentReference().add(value);
    }

    public void insertBillingPayment(PaymentType value)
    {
        getPrepaidPayment().add(value);
    }

    public void insertTaxTotalType(TaxTotalType value){
        if(value==null) return;
        getTaxTotal().add(value);
    }

    public void insertPrepaidPayment(PaymentType value){
        getPrepaidPayment().add(value);
    }
    ...
    public void insertSellerSupplierPartyType(AddressType addressValue) {
    	if(addressValue==null) return;
    	getSellerSupplierParty().getParty().setPostalAddress(addressValue);
    }
    ...
    public void insertPostalAddressType(AddressType addressType){
    	if(addressType == null) return;    	
        this.getAccountingCustomerParty().getParty().setPostalAddress(addressType);
    }
}

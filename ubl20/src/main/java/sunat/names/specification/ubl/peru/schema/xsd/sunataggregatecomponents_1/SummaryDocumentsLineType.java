...
public class SummaryDocumentsLineType {
    ...
    @XmlElement(name = "TotalAmount", required = true,namespace = "urn:sunat:names:specification:ubl:peru:schema:xsd:SunatAggregateComponents-1")
    ...
    {
        getBillingPayment().add(value);
    }
    public void insertAllowanceCharge(AllowanceChargeType value)
    {
        getAllowanceCharge().add(value);
    }

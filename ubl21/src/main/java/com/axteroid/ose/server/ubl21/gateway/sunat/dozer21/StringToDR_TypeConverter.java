 ...
 * Date: 16/02/12
 */
public class StringToDR_TypeConverter implements CustomConverter {
	//private static final Logger log = Logger.getLogger(StringToDR_TypeConverter.class);
	private static final Logger log = LoggerFactory.getLogger(StringToDR_TypeConverter.class);

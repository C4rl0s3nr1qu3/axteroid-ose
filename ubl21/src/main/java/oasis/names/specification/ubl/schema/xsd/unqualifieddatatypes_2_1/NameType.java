...
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.FamilyNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.FileNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.FirstNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.HolderNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.MiddleNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.ModelNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.OtherNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.RegistrationNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.RetailEventNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.RoamingPartnerNameType;
import oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.ServiceNameType;
...
import un.unece.uncefact.data.specification.corecomponenttypeschemamodule._2_1.TextType;
...
@XmlSeeAlso({
    ...
    ModelNameType.class,
    oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2_1.NameType.class,
    OtherNameType.class,

...
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2_1.PercentType;
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2_1.RateType;
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2_1.ValueType;
...
@XmlSeeAlso({
    oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_2_1.NumericType.class,
    ValueType.class,
    PercentType.class,
    RateType.class
})
